...
public class ClassifyListAdapter extends BaseAdapter {
    ...
    private final List<ShopTypeListBean.DataBean.ItemsBean> items;
    private final Context context;

    public ClassifyListAdapter(Context context, List<ShopTypeListBean.DataBean.ItemsBean> items) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ShopTypeListBean.DataBean.ItemsBean bean = items.get(position);
