...
public class DarenLikeAdapter extends BaseAdapter {

    private final Context context;
    private final List<DaRenLikeBean.DataBean.ItemsBean.GoodsBean> goods;


    public DarenLikeAdapter(Context context, List<DaRenLikeBean.DataBean.ItemsBean.GoodsBean> goods) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
         ...
         * 设置数据
         */
        DaRenLikeBean.DataBean.ItemsBean.GoodsBean goodsBean = goods.get(position);
