 ...
 * 作用：xxxx
 */
public class AddSubViewTwo extends LinearLayout {
    ...
    public AddSubViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        //把布局文件实例化成View,并且添加到AddSubView.this类中，成为他的子视图
        View.inflate(context, R.layout.add_sub_viewtwo,AddSubViewTwo.this);
